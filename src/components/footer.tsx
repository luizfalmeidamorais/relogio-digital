  ...
  return (
    <footer className="text-[rgba(5, 5, 5, 0.9)] dark:text-white bg-white dark:bg-relogio p-6 text-center mt-auto">
      <p className="dark:text-white text-[14px]">
        Feito com ❤️ por <a href="https://github.com/luizfalmeidamorais" className="font-bold">Luiz F.</a>
      </p>
      ...
      <div className="font-bold mt-3 text-[15px]">{currentYear} &copy; Apptivium Technologies</div>
    </footer>
  );
}
